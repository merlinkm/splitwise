                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    @endforeach
                                    <a href="/view-expenses/{{$group_id}}"><button class="btn btn-primary">View All Expenses</button></a>
                                </div>
                                    ...
                                    <br>
                                        ...
                                        @foreach ($expense->groups as $item)
                                            @foreach ($item->user as $user)
                                                ...
                                                <p class="f-16"><b class="text-info">{{$user->name}} {{ $user->id == env('SESSION_ID') ? '(You)': ''}}</b> get back ${{ round($expense->amount - $expense->per_person,2) }}</p>
                                                @else
